...
public class ReservationController {
    ...
    @PutMapping("/reserve")
    public ResponseEntity<?> reserve(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestBody ReservationDTO reservationDTO) {
        return reservationService.reserve(userDetails, reservationDTO);
    }
